...
var but1 = but("button", "onclick", "display('(')", "(");
var but2 = but("button", "onclick", "display(')')", ")");
var but3 = but("button", "onclick", "del()", ">");
var but4 = but("button", "onclick", "Clear()", "AC");
...
var but17 = but("button", "onclick", "display('0')", "0");
var but18 = but("button", "onclick", "display('.')", ".");
var but19= but("button", "onclick", "display('/')", "/");
var but20 = but("button", "onclick", "Calculate()", "=" );




but20.setAttribute("class", "equal");
...
div2.append(inp, but1, but2, but3, but4, but5, but6, but7, but8, but9, but10, but11, but12, but13, but14, but15, but16, but17, but18, but19, but20);
div.append(div2);
